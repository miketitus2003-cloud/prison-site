        ...
        <div className="pt-12 sm:pt-16 pb-12">
          ...
          <div className="mt-8 grid lg:grid-cols-12 gap-6">
              ...
              <Card>
                ...
                <div className="mt-4 grid sm:grid-cols-3 gap-3">
                  <div className="rounded-2xl bg-white/6 ring-1 ring-white/10 p-4">
                    <div className="text-xs uppercase tracking-widest text-white/50">Direction</div>
                    <div className="mt-2 text-sm font-semibold text-white">Employment ↘ reoffending</div>
                    <div className="mt-1 text-sm text-white/65">Directional association</div>
                  </div>
                  <div className="rounded-2xl bg-white/6 ring-1 ring-white/10 p-4">
                    <div className="text-xs uppercase tracking-widest text-white/50">Top driver</div>
                    <div className="mt-2 text-sm font-semibold text-white">Offense type mattered</div>
                    <div className="mt-1 text-sm text-white/65">Directional association</div>
                  </div>
                  <div className="rounded-2xl bg-white/6 ring-1 ring-white/10 p-4">
                    <div className="text-xs uppercase tracking-widest text-white/50">Do not conclude</div>
                    <div className="mt-2 text-sm font-semibold text-white">No causality</div>
                    <div className="mt-1 text-sm text-white/65">Transparent limits</div>
                  </div>
                </div>
              </Card>
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="rounded-3xl bg-gradient-to-br from-indigo-500/12 via-white/5 to-sky-500/12 ring-1 ring-white/10 p-6">
