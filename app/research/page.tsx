    ...
    <Container>
      <div className="pt-12 sm:pt-16 pb-12">
        ...
        <div className="mt-4 max-w-3xl">
          <P>
            Question, method, and results in a readable format. Slides below are presented as a scroll-through walkthrough.
          </P>
        </div>
        ...
        <div className="mt-8">
          <SlideGallery
            ...
            subtitle="Scroll through the deck highlights as full widescreen panels."
          />
        </div>
        ...
        <div className="mt-10 grid lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <Card>
              ...
              <P>
                The model results are presented as <span className="font-semibold text-black">directional evidence</span>.
                Stronger versions would use administrative program participation data and additional controls.
              </P>
            </Card>
          </div>
        </div>
